...
\begin{table}[h!]
    ...
    \rowcolor[HTML]{9B9B9B} 
    \textbf{} &
      \textbf{\begin{tabular}[c]{@{}c@{}}Fighters\\ {[}kg/m²{]}\end{tabular}} &
      \textbf{\begin{tabular}[c]{@{}c@{}}Transport and bomber\\ {[}kg/m²{]}\end{tabular}} &
      \textbf{\begin{tabular}[c]{@{}c@{}}General aviation\\ {[}kg/m²{]}\end{tabular}} &
      \textbf{Multiplier} &
      \textbf{Approximate location} \\
    \rowcolor[HTML]{FFFFFF} 
    Wing              & 44    & 49    & 12    & Exposed Platform & 40\% MAC       \\
    \rowcolor[HTML]{EFEFEF} 
    Horizontal tail   & 20    & 27    & 10    & Exposed Platform & 40\% MAC       \\
    \rowcolor[HTML]{FFFFFF} 
    Vertical tail     & 26    & 27    & 10    & Exposed Platform & 40\% MAC       \\
    \rowcolor[HTML]{EFEFEF} 
    Fuselage          & 23    & 24    & 7     & Wetted area      & 40-50\% length \\
    \rowcolor[HTML]{FFFFFF} 
     &
      \cellcolor[HTML]{C0C0C0}\textbf{Weight ratio} &
      \cellcolor[HTML]{C0C0C0}\textbf{Weight ratio} &
      \cellcolor[HTML]{C0C0C0}\textbf{Weight ratio} &
       &
       \\
    ...
    \rowcolor[HTML]{FFFFFF} 
    Landing gear-navy & 0.045 & N.A.  & N.A.  & TOGW             & centroid       \\
    \rowcolor[HTML]{EFEFEF} 
